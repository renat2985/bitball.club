...
Наше устройство использует WebSocket без SSL, что не позволяет ему работать через HTTPS. Поэтому мы оставили [www.bitball.club](https://www.bitball.club) доступным только по протоколу HTTP.
